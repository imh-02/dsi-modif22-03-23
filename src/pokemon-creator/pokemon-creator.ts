 ...
 */
abstract class PokemonsCreator {
    ...
    logic(): string {
        ...
        return `Me llamo ${pokemonActual.getName()}` + `y soy un pokemon de tipo ${pokemonActual.getType()}, ` + `con la habilidad ${pokemonActual.getHability()}`;
    }
